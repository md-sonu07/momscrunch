...
import { Settings as SettingsIcon, Bell, Lock, User, ShieldCheck } from 'lucide-react';
        ...
        <div className="py-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-white dark:border-slate-800 rounded-3xl p-8 lg:p-12 shadow-xl shadow-slate-200/50 dark:shadow-none min-h-[60vh]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Placeholder Setting Cards */}
                    {[
                        { icon: User, title: "Personal Info", desc: "Update your name and contact details" },
                        ...
                        <div key={idx} className="p-6 border border-slate-100 dark:border-slate-800 rounded-2xl hover:border-primary/30 transition-all group cursor-pointer bg-slate-50/50 dark:bg-slate-800/20">
